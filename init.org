...
(use-package recentb
  ...
  :after ivy
  :config
  (recentb-enable-plugins '(info shell elfeed eww man mpv firefox elshogi abema))
...
(use-package cookie-sync
  :after url-curl
  :config
  (setq csync-profile-firefox "~/AppData/Roaming/Mozilla/Firefox/Profiles/shexl6o1.default")
  (cookie-sync-firefox))
#+END_SRC
